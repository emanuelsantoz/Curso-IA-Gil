    ...
    <SlideShell chapter="CÉREBRO">
      ...
      <RevealIf stepIndex={1}>
        <div style={{ marginTop: 50, display: "grid", gap: 20, gridTemplateColumns: "repeat(4, 1fr)" }}>
          {[
            { src: "/imagem/imagem_1slide3.png", alt: "2023 — Multimodalidade" },
            { src: "/imagem/imagem_2slide3.png", alt: "2024 — Vídeo e tempo real" },
            { src: "/imagem/imagem_3slide3.png", alt: "2024–2025 — Raciocínio avançado" },
            { src: "/imagem/imagem_4slide3.png", alt: "2026 — Agentes autônomos" },
          ].map((img) => (
            <div key={img.src} style={{ border: "2px solid #111", borderRadius: 8, overflow: "hidden", background: "#fff" }}>
